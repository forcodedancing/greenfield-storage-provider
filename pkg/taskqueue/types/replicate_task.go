...
func (m *ReplicatePieceTask) DeIncRetry() {
	if m == nil {
		return
	}
	if m.GetTask() == nil {
...
func (m *ReplicatePieceTask) SetRetry(retry int64) {
	if m == nil {
		return
	}
	if m.GetTask() == nil {
...
func (m *ReplicatePieceTask) TransferSealObjectTask() tqueue.SealObjectTask {
	if m == nil {
		return nil
	}
	task := &SealObjectTask{
