...
func NewGCObjectTask(object *storagetypes.ObjectInfo) (*GCObjectTask, error) {
	if object == nil {
...
func (m *GCObjectTask) DeIncRetry() {
	if m == nil {
		return
	}
	if m.GetTask() == nil {
...
func (m *GCObjectTask) SetRetry(retry int64) {
	if m == nil {
		return
	}
	if m.GetTask() == nil {
...
func (m *GCObjectTask) IsRunning() bool {
	if m == nil {
		return false
	}
	return m.GetRunning()
...
func (m *GCObjectTask) StopRunning() {
	if m == nil {
		return
	}
	m.Running = false
