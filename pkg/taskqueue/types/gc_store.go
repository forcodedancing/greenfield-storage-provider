...
func NewGCStoreTask(object *storagetypes.ObjectInfo) (*GCStoreTask, error) {
	if object == nil {
...
func (m *GCStoreTask) SetRetry(retry int64) {
	if m == nil {
		return
	}
	if m.GetTask() == nil {
...
func (m *GCStoreTask) IsRunning() bool {
	if m == nil {
		return false
	}
	return m.GetRunning()
...
func (m *GCStoreTask) StopRunning() {
	if m == nil {
		return
	}
	m.Running = false
