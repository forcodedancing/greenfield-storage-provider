...
func (m *MockMetadata) GetObjectInfo(objectName, bucketName string) (*Object, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetObjectInfo", objectName, bucketName)
	ret0, _ := ret[0].(*Object)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockMetadataMockRecorder) GetObjectInfo(objectName, bucketName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetObjectInfo", reflect.TypeOf((*MockMetadata)(nil).GetObjectInfo), objectName, bucketName)
}
...
// GetObjectInfo mocks base method.
func (m *MockBSDB) GetObjectInfo(objectName, bucketName string) (*Object, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetObjectInfo", objectName, bucketName)
	ret0, _ := ret[0].(*Object)
	ret1, _ := ret[1].(error)
...
// GetObjectInfo indicates an expected call of GetObjectInfo.
func (mr *MockBSDBMockRecorder) GetObjectInfo(objectName, bucketName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetObjectInfo", reflect.TypeOf((*MockBSDB)(nil).GetObjectInfo), objectName, bucketName)
}
